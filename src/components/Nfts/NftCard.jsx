...
export const NftCard = ({ data }) => {
  ...
  return (
    <React.Fragment>
      <div
        className='max-w-sm m-2 bg-white rounded shadow-md dark:bg-gray-700 dark:border-gray-400'
      ...
      >
        ...
        <div className='px-5 pb-5'>
          <h5 className='h-16 text-xl font-semibold tracking-tight text-gray-900 capitalize dark:text-white'>
            {name.slice(0, 50)}
          </h5>
          ...
          <div className='flex flex-wrap items-center justify-between mt-5'>
            {children && (
              <span className='font-bold text-gray-900 text-md dark:text-white'>
